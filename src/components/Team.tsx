    ...
    return (
        <div id="team" className="w-full h-default flex flex-col items-center">
            ...
            <div className="w-full h-full flex flex-col justify-center items-center">
                ...
                <div className="w-full h-full grid grid-cols-2 gap-0 place-items-center md:gap-6 md:grid-cols-3">
                    <div className="-mt-16 w-36 h-36 md:w-52 md:h-52 lg:w-64 lg:h-64 lg:-mt-8">
